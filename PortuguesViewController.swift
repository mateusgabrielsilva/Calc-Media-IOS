//
//  PortuguesViewController.swift
//  Calc Media
//
//  Created by Mateus Gabriel on 24/01/2019.
//  Copyright © 2019 Mateus Gabriel. All rights reserved.
//

import UIKit

class PortuguesViewController: UIViewController {
    ...
    // Ação do Botão a ser executada após o Click
    ...
    func lerCamposTextField(){
        ...
        if let textF1 = txtFaltasB1.text, textF1.isEmpty {
            // Caso esteja Vazio
            faltasB1 = 0
            UserDefaults.standard.set(faltasB1, forKey: "portuguesfaltasB1")
        ...
        if let textF2 = txtFaltasB2.text, textF2.isEmpty {
            // Caso esteja Vazio
            faltasB2 = 0
            UserDefaults.standard.set(faltasB2, forKey: "portuguesfaltasB2")
        ...
        if let textF3 = txtFaltasB3.text, textF3.isEmpty {
            // Caso esteja Vazio
            faltasB3 = 0
            UserDefaults.standard.set(faltasB3, forKey: "portuguesfaltasB3")
        ...
        if let textF4 = txtFaltasB4.text, textF4.isEmpty {
            // Caso esteja Vazio
            faltasB4 = 0
            UserDefaults.standard.set(faltasB4, forKey: "portuguesfaltasB4")
        ...
        UserDefaults.standard.set(faltas, forKey: "portuguesFaltas")
        ...
        if let textN1 = txtNotasB1.text, textN1.isEmpty{
            ...
            notasB1 = 0
            UserDefaults.standard.set(notasB1, forKey: "portuguesnotasB1")
        ...
        if let textN2 = txtNotasB2.text, textN2.isEmpty{
            ...
            notasB2 = 0
            UserDefaults.standard.set(notasB2, forKey: "portuguesnotasB2")
            txtSituacao.text = "Situação : Cursando"
        ...
        if let textN3 = txtNotasB3.text, textN3.isEmpty{
            ...
            notasB3 = 0
            UserDefaults.standard.set(notasB3, forKey: "portuguesnotasB3")
            txtSituacao.text = "Situação : Cursando"
        ...
        if let textN4 = txtNotasB4.text, textN4.isEmpty{
            ...
            notasB4 = 0
            UserDefaults.standard.set(notasB4, forKey: "portuguesnotasB4")
            txtSituacao.text = "Situação : Cursando"
        ...
        UserDefaults.standard.set(media, forKey: "portuguesMedia")
    ...
    func atualizarDados(){
        ...
        let novaFaltaB1 : Int = UserDefaults.standard.integer(forKey: "portuguesfaltasB1")
        
        if novaFaltaB1 > 0 {
            txtFaltasB1.text = String(novaFaltaB1)
        }
        
        let novaFaltaB2 : Int = UserDefaults.standard.integer(forKey: "portuguesfaltasB2")
        
        if novaFaltaB2 > 0 {
            txtFaltasB2.text = String(novaFaltaB2)
        }
        
        let novaFaltaB3 : Int = UserDefaults.standard.integer(forKey: "portuguesfaltasB3")
        
        if novaFaltaB3 > 0 {
            txtFaltasB3.text = String(novaFaltaB3)
        }
        
        let novaFaltaB4 : Int = UserDefaults.standard.integer(forKey: "portuguesfaltasB4")
        
        if novaFaltaB4 > 0 {
            txtFaltasB4.text = String(novaFaltaB4)
        }
        
        let novaFaltas : Int = UserDefaults.standard.integer(forKey: "portuguesFaltas")
        ...
        let novaNotaB1 : Float = UserDefaults.standard.float(forKey: "portuguesnotasB1")
        
        if novaNotaB1 > 0 {
            txtNotasB1.text = String(novaNotaB1)
        }
        
        let novaNotaB2 : Float = UserDefaults.standard.float(forKey: "portuguesnotasB2")
        
        if novaNotaB2 > 0 {
            txtNotasB2.text = String(novaNotaB2)
        }
        
        let novaNotaB3 : Float = UserDefaults.standard.float(forKey: "portuguesnotasB3")
        
        if novaNotaB3 > 0 {
            txtNotasB3.text = String(novaNotaB3)
        }
        
        let novaNotaB4 : Float = UserDefaults.standard.float(forKey: "portuguesnotasB4")
        
        if novaNotaB4 > 0 {
            txtNotasB4.text = String(novaNotaB4)
        }
        
        let novaMedia : Float = UserDefaults.standard.float(forKey: "portuguesportuguesMedia")
